...
// Check l'environnement node pour switch de DB selon si l'on test ou non.
Promise = global.Promise;
const dbUrl = process.env.NODE_ENV === 'test' ? process.env.MONGO_DB_URL_TESTING : process.env.MONGO_DB_URL;
mongoose.connect(dbUrl, {useNewUrlParser: true, useUnifiedTopology: true}, (err) => {
    if (!err) {
        const app = createServer();
        console.log('✅ MongoDB Connection Succeeded. URL: ' + dbUrl);
